...
export const BRAND_MODE_IDS = Object.freeze(['master', 'iris', 'sakura', 'journal', 'violet', 'freesia', 'game', 'wisteria']);
...
export function assertBrandContract(brand) {
  ...
  if (JSON.stringify(familyIds) !== JSON.stringify(['master', 'iris', 'sakura', 'journal', 'violet', 'freesia', 'consumer', 'games', 'wisteria'])) {
  ...
  const requiredPages = ['home', 'portfolio', 'engineering', 'framework', 'journal', 'tools', 'mods', 'brand', 'game', 'contact', 'system', 'wisteria'];
