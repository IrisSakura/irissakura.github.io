...
class BlogApp {
    constructor() {
        ...
        this.blogCategoriesContainer = null;
        this.popularPostsContainer = null;
        this.tagCloudContainer = null;
        this.blogPaginationContainer = null;
        this.blogSearchInput = null;
        this.currentPage = 1;
        this.postsPerPage = 5;
        this.allArticles = [];
        ...
        if (this.tagCloudContainer) {
            this.tagCloudContainer.addEventListener('click', (e) => {
                ...
                if (tagElement) {
                    ...
                    if (tag) {
                        this.filteredArticles = this.allArticles.filter(article => article.tags.includes(tag));
                        this.currentPage = 1;
                        this.renderBlogPosts();
                        this.renderPagination();
                    }
        ...
        if (this.blogSearchInput) {
            this.blogSearchInput.addEventListener('input', () => {
                ...
                if (searchTerm.length >= 2) {
                    this.filteredArticles = this.allArticles.filter(article => article.title.toLowerCase().includes(searchTerm) ||
